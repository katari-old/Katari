...
package com.globant.${clientName}.${projectName}.web.testsupport;
  ...
  public static synchronized ApplicationContext getBeanFactory() {
    if (beanFactory == null) {
      ...
      appContext.setConfigLocations(new String[] {
        ...
        "classpath:/com/globant/${clientName}/${projectName}/web/user/view/spring-servlet.xml" });
      appContext.refresh();
  ...
  public static synchronized ApplicationContext getTimeModuleBeanFactory() {
    if (timeModuleBeanFactory == null) {
      ...
      timeModuleBeanFactory = new FileSystemXmlApplicationContext(
          new String[]
          {"classpath:/com/globant/${clientName}/${projectName}/web/time/view/spring-servlet.xml"},
          getBeanFactory());
    }
