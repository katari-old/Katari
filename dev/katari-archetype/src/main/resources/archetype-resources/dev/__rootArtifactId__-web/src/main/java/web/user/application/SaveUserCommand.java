...
import ${package}.web.integration.SecurityUtils;
...
public class SaveUserCommand implements Command<Void>, Validatable,
  ...
  */
  ...
  /** Contructor, builds a SaveUserCommand suitable for creating new users.
   *
  ...
  /** Contructor, builds a SaveUserCommand suitable for modifying the user
   * profile.
   *
   * @param theUserRepository The user repository. It cannot be null.
   *
  ...
  /** Contructor, builds a SaveUserCommand suitable for changing the user
   * password.
   *
   * @param theUserRepository The user repository. It cannot be null.
   *
   ...
   * @return Returns role options from the role repository.
   */
