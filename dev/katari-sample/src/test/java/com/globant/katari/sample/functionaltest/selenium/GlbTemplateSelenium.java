...
package com.globant.katari.sample.functionaltest.selenium;
...
public class GlbTemplateSelenium extends TestCase {
   ...
   */
  protected static final String BASE_URL = "http://localhost:8099";

  /** The base url where the application is deployed.
   */
  protected static final String APPLICATION_URL = "/katari-web/";
