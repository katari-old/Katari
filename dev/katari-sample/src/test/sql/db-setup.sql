insert into clients(name, status) values ('Google', 'ACTIVE');
insert into clients(name, status) values ('OAG', 'INACTIVE');
insert into projects(name, client_id)
  select 'Google HR', clients.id from clients where clients.name = 'Google';
insert into projects(name, client_id)
  select 'Google CRM', clients.id from clients where clients.name = 'Google';
insert into activities(name, project_id)
  select 'Coding', projects.id from projects where projects.name = 'Google HR';
insert into activities(name, project_id)
  select 'Testing', projects.id from projects where projects.name = 'Google HR';
