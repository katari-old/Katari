...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  ...
  <div class="loginContainer">
    <h3><@spring.message "login.title"/></h3>
    <p><@spring.message "login.instructions"/></p>
    ...
    <form id='login' name='login' method="post"
      ...
      <span class="formfield">
        ...
        <input type="password" class="text" id="j_password" name="j_password"
          ...
          ='<@spring.message "login.password.accesskey"/>'/>
      </span>

      <#if showCaptcha!false>
        <span class="formfield">
          <label for="captcha">
            <@spring.message "login.captcha.instructions"/>
          </label>
          ...
          <input type="submit" class="btn"
            ...
            value='<@spring.message "login.captcha.instructions"/>'
            tabindex="4" />
        </span>
      </#if>
      ...
      <div class="buttons clearfix">
        <input name="loginButton" type="submit" class="btn rightMargin"
          accesskey="l" value='<@spring.message "login.button.submit"/>'
          tabindex="5" />
        <input type="reset" class="btn" accesskey="c"
          value='<@spring.message "login.button.clear"/>'
          tabindex="6" />
