 ...
 * &lt;constructor-arg value='targetList'/&gt; &lt;constructor-arg&gt;
 * &lt;list&gt; ....  &lt;/list&gt; &lt;/constructor-arg&gt; &lt;/bean&gt;
 * </pre> @author gerardo.bercovich
 */
public class ListFactoryAppender implements BeanFactoryPostProcessor {
   ...
   * cannot be null.
   */
  public ListFactoryAppender(final String theTargetList, final boolean
      optional, final List<?> theElements) {
    Validate.notNull(theElements, "the elements cannnot be null.");
    Validate.notNull(theTargetList, "the target list cannnot be null.");
    targetList = theTargetList;
    isOptional = optional;
