 ...
 * element.
 *
 * @see {@link ViewGroupDivision}
 * @author juan.pereyra
 */
public class ViewGroupDivisionDescriptorExtension implements
   ...
   */
  public ViewGroupDivisionDescriptorExtension(final String aCssClass) {
    super();
