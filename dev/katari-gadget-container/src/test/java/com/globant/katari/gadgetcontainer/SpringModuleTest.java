 ...
 * can be created and the gadgetcontainer.module bean is of the expected type.
 */
public class SpringModuleTest {
  ...
  public void createContexts() throws Exception {
    ...
    appContext.setConfigLocations(new String[] {
      "classpath:com/globant/katari/gadgetcontainer/module.xml" });
    appContext.refresh();
  }

  @Test
  public void testModuleType() {
    Object logout = appContext.getBean("gadgetcontainer.module");
