...
package com.globant.katari.socialserver.socialserver;
 ...
 * can be created and the socialserver.module bean is of the expected type.
 */
public class SpringModuleTest {
  ...
  public void createContexts() throws Exception {
    ...
    appContext.setConfigLocations(new String[] {
      "classpath:com/globant/katari/socialserver/socialserver/module.xml" });
    appContext.refresh();
  }

  @Test
  public void testModuleType() {
    Object logout = appContext.getBean("socialserver.module");
