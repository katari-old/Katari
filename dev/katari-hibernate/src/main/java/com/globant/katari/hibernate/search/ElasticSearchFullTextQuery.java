...
public class ElasticSearchFullTextQuery extends AbstractQueryImpl implements
  ...
  /** {@inheritDoc}. */
  public FullTextQuery setSpatialParameters(final double latitude,
      final double longitude, final String fieldName) {
    System.out.println("q carajos");
    return this;
  }

  /** {@inheritDoc}. */
  public FullTextQuery setSpatialParameters(final Coordinates center,
