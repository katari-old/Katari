    ...
    <form id="publishform" action="/publish.groovy" method="POST">
      ...
      <div id="button-bar">
        <div id="actionsBreadcrumb">
          ...
          <span class="actionsBreadcrumbChild" id="executeButton">
            <a href="javascript:void(0)">Execute script</a>
          </span>
          <span class="actionsBreadcrumbLastChild" id="newScriptButton">
            <a href="home.do">New script</a>
          </span>
        </div>
      </div>
    </form>
